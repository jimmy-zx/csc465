...
class And(OperatorWithBinaryOperands, Operator2, Binary, AssociativeOperator, CommutativeOperator):
    DELIM = "∧"


class Or(OperatorWithBinaryOperands, Operator2, Binary, AssociativeOperator, CommutativeOperator):
    DELIM = "∨"
